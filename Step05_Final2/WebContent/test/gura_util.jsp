...
<body>
   ...
   <script>
   	...
   	// 폼 없이 특정시점에 ajax 로 어떤 문자열을 전송하고 싶다면?
   	ajaxPromise("send.jsp","post", "msg=나야나");
   	ajaxPromise("send.jsp","post", {msg:"오잉?"});
   	
   	// 폼 없이 특정시점(버튼을 누른 시점)
   	document.querySelector("#sendBtn").addEventListener("click",function(){
   		ajaxPromise("send.jsp","post","msg=버튼을 눌렀음")
   	});
   	
   	// 폼 없이 특정시점(버튼을 누른시점)에 input 요소에 입력한 정보를 ajax로 전송하고 싶다면?
