...
<script>
   ...
   document.querySelector("#image").addEventListener("change", function(){
      ...
      .then(function(data){
         ...
         let img2='<img id="profileImage" src="${pageContext.request.contextPath }'+data.imagePath+'">';
         ...
         document.querSelector("#profileLink").innerText=""
         document.querSelector("#profileLink").append(imgObj);
         */
